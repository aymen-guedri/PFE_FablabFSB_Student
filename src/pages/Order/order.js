...
const startTimes = ["09:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00"];
const endTimes = ["10:00", "11:00", "12:00", "13:00", "14:00", "15:00", "16:00"];
  // Function to handle form submission
  const handleReservationRequest = () => {
    // Extract form data
    const material = document.getElementById('id_accomodation').value;
    const firstName = document.getElementById('id_name').value;
    ...
    const dateJ = document.getElementById('id_date').value;
    ...
    axios.post('https://fablabfsb-server.onrender.com/api/reservations', reservation)
      .then(response => {
        ...
        // Reset the form
        document.getElementById('id_accomodation').value = '';
        ...
        document.getElementById('id_time1').value = '';
        document.getElementById('id_time2').value = '';
        document.getElementById('id_comments').value = '';
        

        // Show a message below the form
        const successMessage = document.getElementById('success-message');
        successMessage.innerText = 'Reservation submitted successfully!';
    ...
    <div className="container" style={{ marginTop: '80px' }}>
      <div className="panel">
        <div className="panel-heading">
          <h1 style={{color:"blue",fontWeight:"800",fontSize:"18px"}}>FabLab FSB - Reservation</h1>
        </div>
        <div className="panel-body">
          <form className="form-horizontal" role="form">
            ...
            <div className="form-group">
              <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_name">{t('Name_top')}</label>
              <div className="col-md-6">
                <div className="form-group">
                  <div className="col-md-11">
                    <input className="form-control" id="id_name" placeholder={t('Fname')} type="text" />
                  </div>
                </div>

                <div className="form-group internal">
                  <div className="col-md-11">
                    <input className="form-control" id="id_last_name" placeholder={t('Lname')} type="text" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="form-group">
              <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_email">Contact</label>
              <div className="col-md-6">
                <div className="form-group">
                  <div className="col-md-11">
                    <input className="form-control" id="id_email" placeholder={t('contact')} type="text" />
                  </div>
                </div>
            ...
            <div className="form-group">
              <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_accomodation">{t('Material_M')}</label>
              <div className="col-md-2">
                <select className="form-control" id="id_accomodation">
                  <option>3D Printer</option>
                  <option>Vinyl cutting machine</option>
                  <option>Laser cutting</option>
                  <option>Large format CNC</option>
                  <option>3D Scanner</option>
                  <option>Mechanical tool</option>
                </select>
              </div>
            </div>
  ...
  <div className="form-group">
  <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_date">Date</label>
  <div className="col-md-2">
    <DatePicker
      id="id_date"
...
{selectedDate && (
  <div>
    <div className="form-group">
      <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_start_time">{t('start_t')}</label>
    ...
    <div className="form-group">
      <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_end_time">{t('end_t')}</label>
      <div className="col-md-4">
        <select
          id="id_time2"
          className="form-control"
        ...
        >
          ...
          {endTimes.map((time, index) => (
            ...
            <div className="form-group">
              <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_comments">Description</label>
              <div className="col-md-6">
                <textarea
                  className="form-control"
                  id="id_comments"
  ...
  <div className="col-md-offset-4 col-md-3">
    <button className="btn-lg btn-primary" type="button" onClick={handleReservationRequest} style={{ width: '80%', marginBottom: '10px' }}>
    {t('Request_Resv')}
    </button>
  </div>
  ...
  <div className="col-md-2">
    <button className="btn-lg btn-danger" style={{ width: '40%', marginBottom: '10px' }} type="submit">
    {t('cancel_c')}
    </button>
  </div>
</div>
          </form>
          <p id="success-message" style={{ marginTop: '20px', color: 'green' }}></p>
