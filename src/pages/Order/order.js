        ...
        <div className="panel-body">
          <form className="form-horizontal" role="form">
            ...
            <div className="form-group">
              <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_name">Name</label>
              <div className="col-md-6">
                <div className="form-group">
                  <div className="col-md-11">
                    <input className="form-control" id="id_name" placeholder="First Name" type="text" />
                  </div>
                </div>

                <div className="form-group internal">
                  <div className="col-md-11">
                    <input className="form-control" id="id_last_name" placeholder="Last Name" type="text" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="col-md-6">
                <div className="form-group">
                  <div className="col-md-11">
                    <input className="form-control" id="id_email" placeholder="E-mail" type="text" />
                  </div>
                </div>
            ...
            <div className="form-group">
              <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_accomodation">Material</label>
...
{selectedDate && (
  <div>
    <div className="form-group">
      <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_start_time">Start Time</label>
    ...
    <div className="form-group">
      <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_end_time">End Time</label>
      <div className="col-md-4">
        <select
          id="id_time2"
          className="form-control"
          ...
          {endTimes.map((time, index) => (
            ...
            <div className="form-group">
              <div className="col-md-offset-4 col-md-3">
                <button className="btn-lg btn-primary" type="button" onClick={handleReservationRequest}>
                  Request Reservation
                </button>
              </div>
              <div className="col-md-3">
                <button className="btn-lg btn-danger" style={{ float: 'right' }} type="submit">
                  Cancel
                </button>
              </div>
            </div>
